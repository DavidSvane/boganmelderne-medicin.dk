<div class="book">
	...
	<h1 class="title">Anatomiens navne</h1>
	<p class="subtitle">af Jan Rytter Nørgaard, Karin Holmboe.</p>
	...
	<table>
		<tr>
			<td>
				...
				<p class="sprog"><b>Sprog:</b> Andre</p>
				<p class="sider"><b>Sider:</b> 244</p>
				...
				<p class="isbn"><b>ISBN:</b> 9788717038684</p>
			</td>
		
	<!-- Bogens coverbillede gemmes med titlen "cover_" efterfulgt af bogens ISBN-nummer i formatet .jpg (brug Paint eller GIMP) og ISBN-nummeret tilføjes efter "cover_" i feltet herunder. -->
			<td><img class="cover" src="files/book/cover_9788717038684.jpg"/></td>
		</tr>
	</table>
	
	<!-- Beskrivelsen indsættes i et felt herunder mellem <p class="description"> og </p>. Alle unødvendige mellemrum og linjeskift slettes og tjekkes. Ved ønsket linjeskift kopieres og indsættes "<br />" i stedet, og ønskes også mellemrum mellem paragrafferne indsættes "<br />" to gange. -->
	<p class="description">Kommer snarest!</p>
	<br />
